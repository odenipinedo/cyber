...
* enforced through encryption, authentication, access controls, physical security, and permissions

**Integrity**
* information sent or received is not modified by an unauthorized person
* enforced through technical controls such as algorithms or hashes (e.g. MD5, SHA1)

**Availability**
* information and data is always available when needed
* implemented via RAID, clusters, ISP redundancy, backups

**Non-Repudiation**
* valid proof of the identity of the data sender or receiver
* implemented via digital signatures and logs
...
* "Need to Know" access needed for the role
* Single sign-on (SSO)

#### Incident Response

* involves the monitoring and detection of security events on a computer or a computer network and the execution of proper resources to those events.
* The information security or incident management team will regularly check and monitor the security events occurring on a computer or in a network

**Incident Management**

![Key Components](images/09_Incident_Management.png)

**Key Concepts**

![Key Concepts](images/10_SIR_Key_Concepts.png)

**Incident Response Process**

![Crest Incident](images/11_Crest_Incident.jpg)

[Reference](https://www.crest-approved.org/cyber-security-incident-response-maturity-assessment/index.html)

[Mind Map](https://www.mindmeister.com/591683277/incident-response-and-handling-steps)

[Cost of a data breach](https://costofadatabreach.mybluemix.net/)

#### Frameworks and Their Purpose

**Introduction**
* best practices, baselines, and frameworks are used to improve controls, methodologies, and governance
* help to translate business needs into technical or operational requirements
...
* SOX, HIPPA, GLBA, PCI/DSS
* Audits can be internal or external
* External audits often relate to requirements (e.g. HIPPA, SOX, etc)
* [OCTAVE](https://resources.sei.cmu.edu/library/asset-view.cfm?assetID=8419)

**Pentest Process**
* **penetration testing** is a method of evaluating computer and network security by simulating an attack on a computer system or network from external and internal threats
* e.g. Mile 2 CPTE training, offensive security (KALI Linux)

**OWASP Framework**
* [OWASP Top 10 Application Risks](https://owasp.org/Top10/)
